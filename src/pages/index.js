        ...
        <>
            ...
            <Container>
                ...
                <Main>
                    ...
                    <Description>Engenheiro Ambiental e Sanitarista (2018) e mestrando em Recursos Hídricos e Saneamento
                        pela
                    ...
                    <div style={{marginTop: "5rem"}}>
                        <SocialIcon url="https://www.linkedin.com/in/clebsonfarias/" target="_blank"
                                    style={{marginRight: "1rem"}}/>
                        <SocialIcon url="https://twitter.com/clebsonpy" target="_blank" style={{marginRight: "1rem"}}/>
                        <SocialIcon url="https://www.facebook.com/clebsonpy" target="_blank"
                                    style={{marginRight: "1rem"}}/>
                        <SocialIcon url="https://www.instagram.com/clebsonfarias/" target="_blank"
                                    style={{marginRight: "1rem"}}/>
